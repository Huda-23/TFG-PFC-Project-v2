      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative">
          <input
            ...
            id="empresaOrigen"
            placeholder=" "
            className="peer w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-800 focus:border-blue-500 focus:outline-none transition-shadow duration-200 focus:shadow-md focus:shadow-blue-100"
          />
          <label
