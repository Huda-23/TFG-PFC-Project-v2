  ...
  return (
    <section className="bg-gray-50 p-6 rounded-lg shadow-md">
      <h2 className="text-xl font-bold text-blue-700 mb-2">
        Paso 2: Actividades realizadas en el cultivo
      </h2>
      ...
      <form className="space-y-6">
        ...
        <div
          className={`border-2 rounded-lg p-4 transition ${
            labranza ? "border-blue-500 bg-blue-50" : "border-gray-300"
          } cursor-pointer`}
          ...
          <div className="flex items-center gap-3">
            <div
              className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${
                labranza ? "bg-blue-500 border-blue-500" : "border-gray-400"
              }`}
            >
              {labranza && (
        ...
        <div
          className={`border-2 rounded-lg p-4 transition ${
            poda ? "border-blue-500 bg-blue-50" : "border-gray-300"
          } cursor-pointer`}
        ...
        >
          <div className="flex items-center gap-3">
            <div
              className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${
                poda ? "bg-blue-500 border-blue-500" : "border-gray-400"
              }`}
            >
        ...
        <div
          className={`border-2 rounded-lg p-4 transition ${
            fumigacion ? "border-blue-500 bg-blue-50" : "border-gray-300"
          } cursor-pointer`}
        ...
        >
          <div className="flex items-center gap-3">
            <div
              className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${
                fumigacion ? "bg-blue-500 border-blue-500" : "border-gray-400"
              }`}
            >
              {fumigacion && (
                <span className="text-white text-sm font-bold">✓</span>
        ...
        <div
          className={`border-2 rounded-lg p-4 transition ${
            personal ? "border-blue-500 bg-blue-50" : "border-gray-300"
          } cursor-pointer`}
        ...
        >
          <div className="flex items-center gap-3">
            <div
              className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${
                personal ? "bg-blue-500 border-blue-500" : "border-gray-400"
              }`}
            >
              {personal && (
                <span className="text-white text-sm font-bold">✓</span>
